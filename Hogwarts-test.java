...
public class Hogwarts {
	...
	public static void main(String []args) {
		...
		hogwarts.addCourse(-12,"Calculus");
		...
		hogwarts.removeCourse(-12);
		hogwarts.removeCourse(86);
		System.out.println();
		...
		System.out.println("Shoud print Flying: " + hogwarts.getCourse(54));
		System.out.println("Shoud print null: " + hogwarts.getCourse(-12));
		...
		hogwarts.addStudent(-1,"Avner Halevy");
		...
		hogwarts.addCourseTaken(1,4,83);
		...
		hogwarts.addCourseTaken(5,2, 85);
		hogwarts.addCourseTaken(5,3, 79);
		hogwarts.addCourseTaken(5,54, 92);
		...
		System.out.println();
		hogwarts.courseReport(0);	// non existing
		System.out.println();
