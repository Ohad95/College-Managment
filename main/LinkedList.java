...
public class LinkedList<E>
{
	 ...
	 */
	public void addFirst(E e) { //CHECK YOU DID IT
		Node<E> newNode = new Node<E>(e);//WHAT IS THIS E?!
	...
	public void add(E e, int index) {
		...
		try {
			...
			System.err.println("Error - The index you entered is negative or larger than the list's size");
		}
	}
	 ...
	 */
	public int indexOf (E e) { // CHECK IF THE FIRST ELEMENT INDEX SHOULD BE 1 OR 0
        Node<E> current = first;
        int index = 0;
	 ...
	 * @throws NoSuchElementException if the list is empty
	 */
	public E getLast() { // Do you need the try catch here?
		try {
			return last.e;
		}
		catch (NullPointerException e){
